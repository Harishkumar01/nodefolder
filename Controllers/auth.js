...
exports.forgotPassword = (req,res) => {
    ...
    User.findOne({email},(err,user) => {
        ...
        const emailData = {
            ...
            text: `Please use the given link to reset your password: http://139.59.43.98:3000/reset-password/${token}`,
            html: `<p>Please use the given link to reset your password:</p> <p> http://139.59.43.98:3000/reset-password/${token}</p>`
        }
